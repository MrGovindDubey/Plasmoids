...
Kirigami.FormLayout {
    ...
    QQC2.Label {
        font.pixelSize: 12
        text: i18n("When checked, pressing Enter will perform an action in Discord.")
    }
    QQC2.Label {
        font.pixelSize: 8
        font.italic: true
    ...
    QQC2.CheckBox {
        ...
        text: i18n("Allow Discord system clipboard access")
    }
    QQC2.Label {
        font.pixelSize: 8
        font.italic: true
        text: i18n("This is enabled by default to allow for quick sharing, but can be disabled if you are concerned about Discord accessing your system clipboard.")
    }
}
